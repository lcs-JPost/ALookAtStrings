...
let askedCharacter = aQuestion[theIndex]
print(askedCharacter)

var theOtherIndex = aQuestion.index(aQuestion.endIndex, offsetBy: -3)
let otherAskedCharacter = aQuestion[theOtherIndex]
print(askedCharacter)
